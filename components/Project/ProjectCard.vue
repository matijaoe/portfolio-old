...
<template>
  ...
  <div class="lg:-translate-x-4 hover:(bg-zinc-6/20 lg:translate-x-0) transition-all" py-4 pl-3 pr-5 rounded-md cursor-pointer>
    <div class="write-vertical-left rotate-180 text-right" top="50%" font-bold text-5xl text-stone-2 opacity-20>
      {{ project.year }}
    </div>

    <div flex flex-col gap-2>
      <NuxtLink :href="initalLink" class="hover:underline" w-fit>
